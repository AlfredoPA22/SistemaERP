...
namespace Logica
{
    public class LUsuario : LLogica<Usuario>
    {
        ...
        public bool PerimisosController(string controller)
        {
            ...
            permisos.Add(new Permisos("Nota"));
            permisos.Add(new Permisos("Integracion"));
            permisos.Add(new Permisos("Marca"));
            permisos.Add(new Permisos("Origen"));
            permisos.Add(new Permisos("Proveedor"));
