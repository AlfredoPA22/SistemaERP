...
namespace SistemaERPnew.Controllers
{
    ...
    {
        private LUsuarios logica = LUsuarios.Logica.LUsuarios;
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                clientes = logica.listarUsuario(empresa.IdEmpresa);
        ...
        public ActionResult Listar()
        {
            ...
            try
            {
                ...
                List<Usuario> clientes = new List<Usuario>();
                clientes = logica.listarUsuario(empresa.IdEmpresa);
                return PartialView("ListaUsuario", clientes);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public ActionResult Registro(string nombre, string usuario1, string password, string tipo, int estado)
        {
        ...
        public ActionResult ObtenerUsuario(int idusuario)
        {
            ...
            try
            {
                ...
                EUsuario usuario1 = logica.obtenerUsuario(idusuario, empresa.IdEmpresa);
        ...
        [HttpPost]
        public ActionResult Editar(int id, string nombre, string usuario1, string password, string tipo, int estado)
        {
