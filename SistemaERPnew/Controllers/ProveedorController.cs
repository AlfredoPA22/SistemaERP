...
namespace SistemaERPnew.Controllers
{
    ...
    {
        private LProveedor logica = LProveedor.Logica.LProveedor;
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                proveedores = logica.listarProveedor(empresa.IdEmpresa);
        ...
        public ActionResult Listar()
        {
            ...
            try
            {
                ...
                List<Proveedor> proveedores = new List<Proveedor>();
                proveedores = logica.listarProveedor(empresa.IdEmpresa);
                return PartialView("ListaProveedor", proveedores);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public ActionResult Registro(string nombre, string direccion, string descripcion, int telefono,string correo)
        {
            ...
            try
            {
                ...
                Proveedor periodo = new Proveedor()
                {
                    Nombre = nombre,
                    Direccion = direccion,
        ...
        public ActionResult ObtenerProveedor(int idproveedor)
        {
            ...
            try
            {
                ...
                EProveedor proveedor = logica.obtenerProveedor(idproveedor, empresa.IdEmpresa);
        ...
        [HttpPost]
        public ActionResult Editar(int id, string nombre, string direccion, string descripcion, int telefono,string correo)
        {
